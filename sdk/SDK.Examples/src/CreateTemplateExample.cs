        ...
        override public void Execute()
        {
			DocumentPackage template =
                PackageBuilder.NewPackageNamed("CreateTemplateExample: " + DateTime.Now)
                	...
                	.WithSigner(SignerBuilder.NewSignerPlaceholder(new Placeholder("Placeholderd1")))
                	.WithSigner(SignerBuilder.NewSignerPlaceholder(new Placeholder("Placeholderd2")))
