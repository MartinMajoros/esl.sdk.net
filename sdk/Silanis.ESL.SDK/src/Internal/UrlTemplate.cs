...
//		@QueryParam("dir") String orderDir
        ...
        public static readonly string PACKAGE_LIST_STATUS_DATE_RANGE_PATH = "/packages?predefined={status}&from={from}&to={to}&lastUpdatedStartDate={lastUpdatedStartDate}&lastUpdatedEndDate={lastUpdatedEndDate}";
